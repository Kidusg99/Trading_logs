...
def read_range():
    ...
    spreadsheet_id = '1HWRhs9vhCDQzphcPxtX2ws4j2pQ369V-o8oM5q6L55k'
...
def write_range():
    ...
    spreadsheet_id = '1HWRhs9vhCDQzphcPxtX2ws4j2pQ369V-o8oM5q6L55k'  # get the ID of the existing sheet
